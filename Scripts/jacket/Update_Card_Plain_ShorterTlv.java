 ...
 */
public class Update_Card_Plain_ShorterTlv extends JacketTest {

    public Update_Card_Plain_ShorterTlv(ScriptManager scriptmanager) {
        super(scriptmanager);
        scriptName              = "Update Card - short TLV";
    ...
    public void runTest() throws Exception
    {
        ...
        if (!readingCard.equals("010101020A000000000000000000000B01020C01030D0104"))
