 ...
 */
public class Create_Card_BigTrack1_2 extends JacketTest {

    public Create_Card_BigTrack1_2(ScriptManager scriptmanager) {
        super(scriptmanager);
        scriptName              = "Create Card - Track 1 and 2";
    ...
    public void runTest() throws Exception
    {
        ...
        offset = TLVBuilder.putTLV(    TRACK_1,       track1,   commandData, offset) ;
        offset = TLVBuilder.putTLV(    TRACK_2,       track2,   commandData, offset) ;
       ...
       readingCard = ByteArray.bytesToHexString(response, 0, response.length - 2, "") ;
        ...
        if (!readingCard.equals("034F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F4F042828282828282828282828282828282828282828282828282828282828282828282828282828282828"))
            throw new Exception("ERROR: faile to read the card correctly: " + readingCard) ;
