 ...
 */
public class Create_Card_Enc extends JacketTest {

    public Create_Card_Enc(ScriptManager scriptmanager) {
        super(scriptmanager);
        scriptName              = "Create Card - encrypted";
        scriptDescription       = "Verify that a card can be created with encrypted data.";
    }
