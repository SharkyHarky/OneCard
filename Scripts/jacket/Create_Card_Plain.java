 ...
 */
public class Create_Card_Plain extends JacketTest {

    public Create_Card_Plain(ScriptManager scriptmanager) {
        super(scriptmanager);
        scriptName              = "Create Card - plain";
        scriptDescription       = "Verify that a card can be created with plaintext data.";
    }
